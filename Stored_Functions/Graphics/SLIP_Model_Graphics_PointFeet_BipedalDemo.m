...
%
classdef SLIP_Model_Graphics_PointFeet_BipedalDemo < OutputCLASS 
    % Private attributes:
    properties 
        % The output window
        fig; 
    ...
    methods
        % Constructor:
        function obj = SLIP_Model_Graphics_PointFeet_BipedalDemo(screen_horizontal, screen_vertical)
...
%             axis off;
            ...
            set(obj.fig, 'position', [0.125*screen_horizontal 0.15*screen_vertical 0.45*screen_horizontal 0.35*screen_vertical]);
            axis off;
            ax = gca;
