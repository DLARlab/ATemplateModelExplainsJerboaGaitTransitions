function [residual, T,Y,P,Y_EVENT,TE] = ZeroFunc_BipedApex_offset(X,Offsets)
...
% %       loose x_dot and y constrain   
%         residual(1) = (Y(1,2) - YAPEX(2))/447; % sqrt(2000) = 44
%         residual(2) = (Y(1,3) - YAPEX(3))/100000;
%         residual(3:7) = Y(1,4:8).' - YAPEX(4:8);
    else
        residual(1:3) = Y(1,2:4).' - YAPEX(2:4);  %/original code
% %       loose x_dot and y constrain  
%         residual(1) = (Y(1,2) - YAPEX(2))/447;
%         residual(2) = (Y(1,3) - YAPEX(3))/100000;
%         residual(1) = Y(1,4) - YAPEX(4);
