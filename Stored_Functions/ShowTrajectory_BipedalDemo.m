function  ShowTrajectory_BipedalDemo( T,Y,P ,FileName,screen_horizontal, screen_vertical)
...
if ShowVideo == 1
    graphOUTPUT = SLIP_Model_Graphics_PointFeet_BipedalDemo(screen_horizontal, screen_vertical);     
...
%% Plot ground reaction force diagram
 pause(1.5)
 grf = figure; clf; set(grf,'position',[0.575*screen_horizontal 0.15*screen_vertical 0.25*screen_horizontal 0.35*screen_vertical]);  plot(T,FLy,T,FRy,'LineWidth',2); grid on;  
